...
$CONFIG = '{"lang":"es","error_reporting":true,"show_hidden":true,"hide_Cols":true,"calc_folder":true,"theme":"dark"}';

define('VERSION', '0.0.1');

define('APP_TITLE', 'GESTOR DE ARCHIVOS SENA');
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']])) {
                ...
                fm_set_msg(lng('¡Bienvenido! Ha iniciado sesión correctamente.'));
                fm_redirect(FM_SELF_URL . '?p=');
            } else {
                unset($_SESSION[FM_SESSION_ID]['logged']);
                fm_set_msg(lng('Error al iniciar sesión. Nombre de usuario o contraseña incorrectos'), 'error');
                fm_redirect(FM_SELF_URL);
            }
        } else {
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg width="206" height="70.301" viewBox="0 0 240 72.301" xmlns="http://www.w3.org/2000/svg"><g id="svgGroup" stroke-linecap="round" fill-rule="evenodd" font-size="19pt" stroke="#000" stroke-width="0.25mm" fill="#000" style="stroke:#000;stroke-width:0.25mm;fill:#000"><path d="M 141.9 1.201 L 154.2 1.201 L 154.2 72.301 L 153.2 72.301 L 119.8 34.201 L 116.7 30.201 L 117.2 39.901 L 117.2 70.901 L 104.9 70.901 L 104.9 0.001 L 106 0.001 L 138.9 38.401 L 142.4 42.951 L 141.9 33.401 L 141.9 1.201 Z M 66.5 59.601 L 92.4 59.601 L 92.4 70.901 L 54 70.901 L 54 1.201 L 90.4 1.201 L 90.4 12.101 L 66.5 12.101 L 66.5 28.401 L 85.5 28.401 L 85.5 39.001 L 66.5 39.001 L 66.5 59.601 Z M 0 64.401 L 5.1 53.901 A 11.053 11.053 0 0 0 6.082 55.005 Q 7.095 56.012 8.6 57.101 A 23.296 23.296 0 0 0 12.15 59.202 A 27.883 27.883 0 0 0 13.975 60.001 A 16.829 16.829 0 0 0 18.287 61.104 A 15.139 15.139 0 0 0 20 61.201 A 11.855 11.855 0 0 0 23.212 60.785 A 9.352 9.352 0 0 0 26.625 59.026 A 7.083 7.083 0 0 0 29.206 54.32 A 10.328 10.328 0 0 0 29.3 52.901 A 8.937 8.937 0 0 0 29.013 50.589 A 7.258 7.258 0 0 0 28.075 48.476 A 12.293 12.293 0 0 0 25.844 45.938 A 14.838 14.838 0 0 0 24.825 45.126 A 42.664 42.664 0 0 0 23.677 44.322 Q 22.352 43.422 20.449 42.238 A 192.352 192.352 0 0 0 18.6 41.101 Q 12.85 37.601 9.6 35.126 A 20.832 20.832 0 0 1 5.566 31.018 A 25.983 25.983 0 0 1 3.975 28.626 Q 1.6 24.601 1.6 18.901 A 22.069 22.069 0 0 1 2.251 13.44 A 18.181 18.181 0 0 1 3.975 9.076 A 16.253 16.253 0 0 1 10.392 2.728 A 19.778 19.778 0 0 1 11 2.401 A 20.658 20.658 0 0 1 16.477 0.529 Q 18.881 0.051 21.628 0.006 A 35.077 35.077 0 0 1 22.2 0.001 A 28.757 28.757 0 0 1 31.133 1.336 A 24.137 24.137 0 0 1 40 6.501 L 34.4 16.701 A 9.862 9.862 0 0 0 33.652 15.78 Q 32.919 14.972 31.85 14.076 A 14.762 14.762 0 0 0 29.584 12.525 A 18.957 18.957 0 0 0 27.75 11.626 Q 25.35 10.601 22.7 10.601 A 10.681 10.681 0 0 0 20.257 10.864 Q 18.12 11.366 16.725 12.826 A 7.605 7.605 0 0 0 14.622 17.732 A 10.049 10.049 0 0 0 14.6 18.401 A 8.685 8.685 0 0 0 15.026 21.158 A 7.764 7.764 0 0 0 15.875 22.926 A 13.204 13.204 0 0 0 18.355 25.753 A 15.62 15.62 0 0 0 19.225 26.451 Q 21.3 28.001 24.8 30.101 Q 30.034 33.192 33.23 35.468 A 49.644 49.644 0 0 1 34.5 36.401 A 21.338 21.338 0 0 1 39.539 41.917 A 24.76 24.76 0 0 1 40.125 42.876 Q 42.4 46.801 42.4 52.501 Q 42.4 58.551 39.8 62.951 A 16.886 16.886 0 0 1 32.426 69.64 A 20.328 20.328 0 0 1 32.35 69.676 A 22.953 22.953 0 0 1 26.34 71.556 A 31.672 31.672 0 0 1 20.9 72.001 A 35.048 35.048 0 0 1 14.229 71.384 A 31.094 31.094 0 0 1 12.125 70.901 A 35.4 35.4 0 0 1 8.256 69.639 A 26.894 26.894 0 0 1 4.9 68.051 Q 2.466 66.677 0.833 65.211 A 14.432 14.432 0 0 1 0 64.401 Z M 207.4 70.901 L 203.5 60.801 L 178.6 60.801 L 174.9 70.901 L 160.9 70.901 L 190.4 0.001 L 191.4 0.001 L 221 70.901 L 207.4 70.901 Z M 182.2 51.101 L 199.8 51.101 L 192.5 32.101 L 190.8 26.501 L 189.2 32.101 L 182.2 51.101 Z" vector-effect="non-scaling-stroke"/></g></svg>
                                            </svg>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">SENA CATA</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_POST['ajax']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] == "save") {
        ...
        if ($write_results === false){
            ...
            die("No fue posible escribir el archivo! - Verifique los permisos / Propiedad");
        }
        die(true);
    }
    ...
    if (isset($_POST['type']) && $_POST['type'] == "backup" && !empty($_POST['file'])) {
        ...
        try {
            ...
            if (copy($fullyQualifiedFileName, $fullPath . $newFileName)) {
                echo "Respaldo {$newFileName} creado";
            } else {
                throw new Exception("No se pudo copiar el archivo {$fileName}");
            }
        } catch (Exception $e) {
            echo $e->getMessage();
        }
    ...
    if(isset($_POST['type']) && $_POST['type'] == "upload" && !empty($_REQUEST["uploadurl"])) {
        ...
        if(!$isFileAllowed) {
            $err = array("message" => "Extensión del archivo no permitida");
            event_callback(array("fail" => $err));
            exit();
        }
...
if (isset($_GET['del']) && !FM_READONLY) {
    ...
    if ($del != '' && $del != '..' && $del != '.') {
        ...
        fm_set_msg(lng('Archivo no valido'), 'error');
    }
    fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH));
}
        ...
        if ($_GET['type'] == "file") {
            if (!file_exists($path . '/' . $new)) {
                if(fm_is_valid_ext($new)) {
                    @fopen($path . '/' . $new, 'w') or die('No se pudo abrir el archivo:  ' . $new);
            ...
            if (fm_mkdir($path . '/' . $new, false) === true) {
                fm_set_msg(sprintf(lng('Folder').' <b>%s</b> '.lng('Creado'), $new));
            } elseif (fm_mkdir($path . '/' . $new, false) === $path . '/' . $new) {
                fm_set_msg(sprintf(lng('Folder').' <b>%s</b> '.lng('Ya exixte'), fm_enc($new)), 'alert');
            } else {
                fm_set_msg(sprintf(lng('Folder').' <b>%s</b> '.lng('No creado'), fm_enc($new)), 'error');
            }
        }
    } else {
        fm_set_msg(lng('Caracteres invalidos en el nombre del archivo'), 'error');
    }
    fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH));
}
...
if (isset($_POST['file'], $_POST['copy_to'], $_POST['finish']) && !FM_READONLY) {
    ...
    if (is_array($files) && count($files)) {
        ...
        fm_set_msg(lng('Nada seleccionado'), 'alert');
    }
    fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH));
}
            ...
            <div class="card-body">
                ...
                <div class="upload-url-wrapper card-tabs-container hidden" id="urlUploader">
                    <form id="js-form-url-upload" class="form-inline" onsubmit="return upload_from_url(this);" method="POST" action="">
                        ...
                        <button type="submit" class="btn btn-primary ml-3"><?php echo lng('Subir') ?></button>
            ...
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <div class="form-group row">
                        <label for="js-language" class="col-sm-3 col-form-label"><?php echo lng('Idioma') ?></label>
                        <div class="col-sm-5">
                    ...
                    ?>
                    <div class="form-group row">
                        <label for="js-err-rpt-1" class="col-sm-3 col-form-label"><?php echo lng('Error al Reportar') ?></label>
                        <div class="col-sm-9">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-secondary <?php echo getChecked($report_errors, 1, 'active') ?>">
                                    <input type="radio" name="js-error-report" id="js-err-rpt-1" autocomplete="off" value="true" <?php echo getChecked($report_errors, 1, 'checked') ?> > SI
                                </label>
                                <label class="btn btn-secondary <?php echo getChecked($report_errors, '', 'active') ?>">
                                    <input type="radio" name="js-error-report" id="js-err-rpt-0" autocomplete="off" value="false" <?php echo getChecked($report_errors, '', 'checked') ?> > NO
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="js-hdn-1" class="col-sm-3 col-form-label"><?php echo lng('Mostrar archivos ocultos') ?></label>
                        <div class="col-sm-9">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-secondary <?php echo getChecked($show_hidden_files, 1, 'active') ?>">
                                    <input type="radio" name="js-show-hidden" id="js-hdn-1" autocomplete="off" value="true" <?php echo getChecked($show_hidden_files, 1, 'checked') ?> > SI
                                </label>
                                <label class="btn btn-secondary <?php echo getChecked($show_hidden_files, '', 'active') ?>">
                                    <input type="radio" name="js-show-hidden" id="js-hdn-0" autocomplete="off" value="false" <?php echo getChecked($show_hidden_files, '', 'checked') ?> > NO
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="js-hid-1" class="col-sm-3 col-form-label"><?php echo lng('Ocultar columnas') ?></label>
                        <div class="col-sm-9">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-secondary <?php echo getChecked($hide_Cols, 1, 'active') ?>">
                                    <input type="radio" name="js-hide-cols" id="js-hid-1" autocomplete="off" value="true" <?php echo getChecked($hide_Cols, 1, 'checked') ?> > SI
                                </label>
                                <label class="btn btn-secondary <?php echo getChecked($hide_Cols, '', 'active') ?>">
                                    <input type="radio" name="js-hide-cols" id="js-hid-0" autocomplete="off" value="false" <?php echo getChecked($hide_Cols, '', 'checked') ?> > NO
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="js-dir-1" class="col-sm-3 col-form-label"><?php echo lng('Calcular tamaño de la carpeta') ?></label>
                        <div class="col-sm-9">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-secondary <?php echo getChecked($calc_folder, 1, 'active') ?>">
                                    <input type="radio" name="js-calc-folder" id="js-dir-1" autocomplete="off" value="true" <?php echo getChecked($calc_folder, 1, 'checked') ?> > SI
                                </label>
                                <label class="btn btn-secondary <?php echo getChecked($calc_folder, '', 'active') ?>">
                                    <input type="radio" name="js-calc-folder" id="js-dir-0" autocomplete="off" value="false" <?php echo getChecked($calc_folder, '', 'checked') ?> > NO
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="js-3-1" class="col-sm-3 col-form-label"><?php echo lng('Tema') ?></label>
                        <div class="col-sm-5">
                            <select class="form-control" id="js-3-0" name="js-theme-3" style="width:100px;">
                         <option value='light' <?php if($theme == "light"){echo "selected";} ?>><?php echo lng('Claro') ?></option>
                         <option value='dark' <?php if($theme == "dark"){echo "selected";} ?>><?php echo lng('Oscuro') ?></option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a target="_blank" class="app-v-title"> SENA CATA <?php ; ?></a></h3></p>
                        <p>Didier Eduardo Aponte Castellanos</p>
                        <p>Correo: <a href="mailto:deaponte08@misena.edu.co">deaponte08@misena.edu.co</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://github.com/SeintAP/Gestor-de-Archivos-SENA/wiki/Gestor-de-archivos-SENA" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Documentos de ayuda') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/SeintAP/Gestor-de-Archivos-SENA/wiki/Gestor-de-archivos-SENA" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Reportar error') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
                                <li class="list-group-item"><a href="javascript:show_new_pwd();"><i class="fa fa-lock"></i> <?php echo lng('Generar nueva contraseña hash') ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <form class="form-inline" onsubmit="return new_password_hash(this)" method="POST" action="">
                            ...
                            <div class="form-group mb-2">
                                <label for="staticEmail2"><?php echo lng('Generar nueva contraseña') ?></label>
                            </div>
                            <div class="form-group mx-sm-3 mb-2">
                                <label for="inputPassword2" class="sr-only"><?php echo lng('Password') ?></label>
                                <input type="text" class="form-control btn-sm" id="inputPassword2" name="inputPassword2" placeholder="<?php echo lng('Password') ?>" required>
                            </div>
                            <button type="submit" class="btn btn-success btn-sm mb-2"><?php echo lng('Generar') ?></button>
                        </form>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a  target="_blank" class="float-right text-muted">SENA CATA <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a target="_blank" class="float-right text-muted">SENA CATA <?php ; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Administrador de archivos<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily">
    <meta name="author" content="Didier Eduardo Aponte Castellanos">
    ...
    <style>
        body.fm-login-page{ background-image:url('https://i.im.ge/2022/10/14/27BS4G.res-backg.jpg');}
        .fm-login-page .brand{ width:200px;overflow:hidden;margin:0 auto;position:relative;z-index:1}
        .fm-login-page .brand img{ width:10%}
        .fm-login-page .card-wrapper{ width:360px;margin-top:20%;margin-left:auto;margin-right:auto;}
        .fm-login-page .card{ border-color:transparent;box-shadow:0 10px 8px rgba(0,0,0,.05)}
        .fm-login-page .card-title{ margin-bottom:1.5rem;font-size:24px;font-weight:600; color:#23A600 ;}
        .fm-login-page .form-control{ border-width:2.3px}
        .fm-login-page .form-group label{ width:100%}
        .fm-login-page .btn.btn-block{ padding:12px 10px;background-color:#23A600 ; font-weight:700; border-color:#bababa;}
        .fm-login-page .footer{ margin:40px 0;color:#bababa;text-align:center }
        ...
        .message{ padding:4px 7px;border:1px solid #ddd;background-color:#FFFFFF}
        .message.ok{ border-color:green;color:green}
        .message.error{ border-color:red;color:red}
        .message.alert{ border-color:orange;color:orange}
        body.fm-login-page.theme-dark {background-color: #353535;}
...
<head>
    ...
    <?php endif; ?>
    <style>
        body { font-size:16px;color:#222;background:#F7F7F7; }
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .fa.fa-home { font-size:1.5em;vertical-align:bottom; color:#23A600; }
        .path { margin-bottom:10px  }
        form.dropzone { min-height:200px;border:2px dashed #23A600;line-height:6rem; }
        ...
        .inline-actions > a > i { font-size:1em;margin-left:5px;background:#23A600;color:#fff;padding:5px;border-radius:3px}
        ...
        .btn-2 { border-radius:0;padding:3px 6px;font-size:small; background-color: #23A600 ; color:white; border-color: white}
        li.file:before,li.folder:before { font:normal normal normal 14px/1 FontAwesome;content:"\f016";margin-right:5px }
        li.folder:before { content:"\f114" }
        i.fa.fa-folder-o { color:#23A600}
        i.fa.fa-picture-o { color:#26b99a }
        i.fa.fa-file-archive-o { color:#da7d7d }
        .btn-2 i.fa.fa-file-archive-o { color:inherit }
        i.fa.fa-css3 { color:#f36fa0 }
        i.fa.fa-file-code-o { color:#23A600 }
        i.fa.fa-code { color:#cc4b4c }
        i.fa.fa-file-text-o { color:#0096e6 }
        i.fa.fa-html5 { color:#d75e72 }
        i.fa.fa-file-excel-o { color:#09c55d }
        i.fa.fa-file-powerpoint-o { color:#f6712e }
        i.go-back { font-size:1.2em;color:#23A600; }
        ...
        .ekko-lightbox-nav-overlay a:hover { color:#23A600; }
        ...
        .lds-facebook div { position:absolute;left:6px;width:13px;background:#ff3700;animation:lds-facebook 1.2s cubic-bezier(0,.5,.5,1) infinite }
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            body.theme-dark { background-color: #3d3c3c; }
            .list-group .list-group-item { background: #575859; }
            .theme-dark .navbar-nav i, .navbar-nav .dropdown-toggle, .break-word { color: #ffffff; }
            a, a:hover, a:visited, a:active, #main-table .filename a { color: #fcfbfa; }
            ul#search-wrapper li:nth-child(odd) { background: #23A600; }
            .theme-dark .btn-outline-primary { color: #fcfbfa; border-color: #23A600; }
            .theme-dark .btn-outline-primary:hover, .theme-dark .btn-outline-primary:active { background-color: #23A600;}
        </style>
    <?php endif; ?>
</head>
...
<script>
    ...
    //TFM Config
    window.curi = "https://github.com/SeintAP/Gestor-de-Archivos-SENA/wiki/Gestor-de-archivos-SENA", window.config = null;
